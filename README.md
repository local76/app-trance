...
How to Install:
- exe / msi / deb / rpm: Download from the releases page (https://github.com/local76/trance-tui/releases)
- winget: winget install local76.trance-tui
- aur: yay -S trance-tui-bin
